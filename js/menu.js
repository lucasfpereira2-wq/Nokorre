        ...
        this.innerHTML = `
            <aside class="sidebar" id="mySidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    <a href="${prefix}pages/sdr.html" class="${currentPath.includes('sdr') ? 'active' : ''}" title="Gestão SDR">
                        <div class="icon-box">${iconSDR}</div>
                        <span class="nav-text">Gestão SDR</span>
                    </a>
