class SidebarMenu extends HTMLElement {
    ...
    connectedCallback() {
        ...
        const iconDash = `<svg fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24"><rect x="3" y="3" width="7" height="9"></rect><rect x="14" y="3" width="7" height="5"></rect><rect x="14" y="12" width="7" height="9"></rect><rect x="3" y="16" width="7" height="5"></rect></svg>`;
        ...
        this.innerHTML = `
            <aside class="sidebar" id="mySidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    <a href="#" title="Dashboard Geral">
                        <div class="icon-box">${iconDash}</div>
